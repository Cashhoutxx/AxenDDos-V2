...
APP_IMAGE_URL = "https://i.pinimg.com/736x/ec/6c/ef/ec6cef50d203a8df815bcf90df2aae16.jpg"
...
class AttackThread(QThread):
    ...
    def run(self):
        ...
        """
        self.log_signal.emit(" AyxenDDos is ACTIVATED! TARGET LOCKED! \n")
        if self.use_proxy:
        ...
        if self.running:AxenDDos FINISHED. TARGET ELIMINATED. ")
    ...
    def stop(self):
        ...
        """
        self.running = False
        self.log_signal.emit("\n AxenDDos HALTED BY USER.")


class MainWindow(QMainWindow):
    """
    The main application window for the AxenDDos simulated DDoS tool.
    Provides an enhanced user interface with more visual feedback and controls.
    """
    def __init__(self):
        super().__init__()
        self.setWindowTitle("AxenDDos by Aymen.py")
        ...
        self.credit_label = QLabel("by AxenDDos")
        ...
        self.start_button = QPushButton("LAUNCH AxenDDos")
    ...
    def load_image_from_url(self, url):
        ...
        try:
            ...
            if not pixmap.isNull():
                ...
                self.log_message(" IMAGE LOADED! AxenDDos IS READY!")
            else:
    ...
    def start_attack(self):
        ...
        self.log_message(" Launching AxenDDos ...")
    ...
    def stop_attack(self):
        ...
        self.progress_bar.setValue(0)
        self.log_message("AxenDDos stopped.")
